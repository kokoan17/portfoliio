      ...
      <div className={styles.block_experience}>
        <div className={styles.experience_items_left}>
          <div className={styles.experience_item}>
            ...
            <p>
              ...
              отрисовкой парковочных мест в онлайн режиме, также в решении
              использовали компьютерное зрение, с помощью которого получали
              актуальную инофрмацию о парковочных местах. По результатам Урбатона мы заняли 3 место.
            </p>
          </div>
          <div className={classNames(styles.experience_item, styles.response_item_1)}>
            ...
            <p>
              ...
              smart tables. Мы собираем инофрмацию по футбольным событям, я
        ...
        <div className={styles.experience_item}>
          ...
          <p>
            ...
            частью для строительной компании, то есть, сайт под ключ,
